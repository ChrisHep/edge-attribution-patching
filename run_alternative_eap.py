...
import numpy as np
from eapp.eap_alternative_wrapper import EAP
...
def run_exp(args: DictConfig):
    ...
    if args.debug_run:
        intervention_list_arabic = intervention_list_arabic[:3]
    ...
    if args.debug_run:
        intervention_list_words = intervention_list_words[:3]
