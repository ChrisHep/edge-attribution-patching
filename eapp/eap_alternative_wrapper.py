...
def EAP_corrupted_backward_hook(
    ...
    print(f"result_per_position shape: {result_per_position.shape}")
    print(f"upstream_activations_difference shape: {upstream_activations_difference.shape}")
    print(f"hook_slice: {hook_slice}")
    print(f"earlier_upstream_nodes_slice: {earlier_upstream_nodes_slice}")
    ...
    #print(f"graph.eap_scores shape: {graph.eap_scores.shape}")
    print(f"graph.eap_scores_per_position shape: {graph.eap_scores_per_position.shape}")
    print(f"\n")
